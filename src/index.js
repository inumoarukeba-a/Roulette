...
=========================================================== */
// DOM構築後
doc.addEventListener("DOMContentLoaded", e => {}, false);

// ロード後
win.addEventListener("load", e => {}, false);
...
win.addEventListener(
  "scroll",
  _.throttle(e => {}, 250, { trailing: false, leading: true })
);
